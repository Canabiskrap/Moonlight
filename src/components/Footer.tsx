        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div className="col-span-1 md:col-span-2 space-y-6">
            <Link to="/" className="flex items-center gap-3">
              ...
              <span className="text-2xl font-black tracking-tighter text-white">Moonlight Store</span>
            </Link>
            <p className="text-gray-400 max-w-sm leading-relaxed font-medium">
              نصمم مستقبلك الرقمي باحترافية. متجر Moonlight Store يقدم أفضل الخدمات الرقمية والتصاميم العصرية لمشاريعك.
            </p>
