  ...
  return (
    ...
    >
      ...
      <div className="bg-dark-light/50 border border-white/5 rounded-[2rem] p-8 md:p-12 space-y-8 backdrop-blur-sm">
        ...
        <section className="space-y-4">
          <h2 className="text-2xl font-black text-primary">2. المنتجات الرقمية</h2>
          <p className="text-gray-300 leading-relaxed">
        ...
        <section className="space-y-4">
          <h2 className="text-2xl font-black text-primary">3. سياسة الاسترداد (Refund Policy)</h2>
          <p className="text-gray-300 leading-relaxed">
        ...
        <section className="space-y-4">
          <h2 className="text-2xl font-black text-primary">5. التعديلات على الشروط</h2>
          <p className="text-gray-300 leading-relaxed">
